        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <div className="bg-white p-4 rounded shadow col-span-3">
            ...
            <table className="w-full table-auto">
              ...
              <tbody>
                <tr>
                  <td className="px-4 py-2 border-b">Cell 1</td>
                  <td className="px-4 py-2 border-b">Cell 2</td>
                  <td className="px-4 py-2 border-b">Cell 3</td>
                </tr>
                <tr>
                  <td className="px-4 py-2 border-b">Cell 4</td>
                  <td className="px-4 py-2 border-b">Cell 5</td>
                  <td className="px-4 py-2 border-b">Cell 6</td>
                </tr>
              </tbody>
            </table>
          </div>
