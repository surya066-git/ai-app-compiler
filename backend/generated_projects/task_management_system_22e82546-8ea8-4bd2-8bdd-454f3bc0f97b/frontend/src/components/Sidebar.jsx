  ...
  return (
    <aside className="w-60 shrink-0 border-r border-slate-200 bg-white p-4">
      ...
      <nav className="flex flex-col gap-1">
        ...
        <Link className="rounded-md px-3 py-2 text-sm font-medium text-slate-700 hover:bg-slate-100" to="/projects">Projects</Link>
        <Link className="rounded-md px-3 py-2 text-sm font-medium text-slate-700 hover:bg-slate-100" to="/tasks">Tasks</Link>
